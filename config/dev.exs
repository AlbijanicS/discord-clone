...
config :discord_clone, DiscordCloneWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "P9gpFvDxVQJUhd4QLbGdEY1GHQcEc7/9KXNt3vEPMiunuH3ugmd3Dfm4VVVySQIn",
  watchers: [
...
config :discord_clone, DiscordCloneWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/discord_clone_web/router\.ex\z",
      ~r"lib/discord_clone_web/(controllers|live|components)/.*\.(ex|heex)\z"
    ]
  ]
