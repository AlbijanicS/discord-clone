...
- [x] Message rows expose a small fixed reaction palette.
- [x] The palette includes a familiar v1 set such as thumbs up, heart, laugh,
      party, and eyes.
- [x] Palette controls are visually subtle and do not clutter the default
      timeline.
- [x] Palette controls have stable DOM IDs for tests.
- [x] Palette controls include accessible labels.
- [x] Clicking a palette control calls the Chat reaction toggle workflow.
- [x] Invalid client payloads still fail through backend validation.
- [x] Focused LiveView tests verify that a visible palette control can toggle a
