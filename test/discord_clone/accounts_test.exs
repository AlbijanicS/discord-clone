defmodule DiscordClone.AccountsTest do
  ...
  describe "register_user/1" do
    ...
    test "validates email when given" do
      {:error, changeset} =
        Accounts.register_user(%{email: "not valid", username: unique_user_username()})
    ...
    test "validates username when given" do
      {:error, changeset} =
        Accounts.register_user(%{email: unique_user_email(), username: "not valid"})

      assert %{username: ["must use only lowercase letters, numbers, and underscores"]} =
               errors_on(changeset)
    end
    ...
    test "validates maximum values for email for security" do
      ...
      {:error, changeset} =
        Accounts.register_user(%{email: too_long, username: unique_user_username()})
    ...
    test "validates email uniqueness" do
      ...
      {:error, changeset} =
        Accounts.register_user(%{email: email, username: unique_user_username()})
    ...
    test "validates username uniqueness" do
      ...
      {:error, changeset} =
        Accounts.register_user(%{email: unique_user_email(), username: String.upcase(username)})
