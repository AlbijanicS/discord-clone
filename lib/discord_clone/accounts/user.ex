defmodule DiscordClone.Accounts.User do
  ...
  schema "users" do
    ...
    has_many :owned_workspaces, DiscordClone.Workspaces.Workspace, foreign_key: :owner_id
    has_many :workspace_memberships, DiscordClone.Workspaces.WorkspaceMembership

    has_many :workspace_invites, DiscordClone.Workspaces.WorkspaceInvite,
