defmodule DiscordClone.Workspaces.WorkspaceAuditEvent do
  ...
  @event_types ~w(member_role_promoted member_role_demoted member_muted member_unmuted member_timed_out member_timeout_removed member_timeout_expired member_kicked moderator_message_deleted)
